...
# ubuntu command to kill process: kill -9 $(ps -ef | grep python | grep fureplaceanonymous | grep -v grep | awk '{print $ 2}')

n_run = 8
n_run_mode = [
    {
        "addr": "172.18.116.149:2233",
        "usr": "fureplaceanonymous",
        "pwd": "clara"
    },
]*8
...
conf_override = {
    "config.py->GlobalConfig-->note":       
                [
                    r"dca-phase1-50-110%ememy-run1",
                    r"dca-phase1-50-110%ememy-run2",
                    r"dca-phase1-50-110%ememy-run3",

                    r"dca-phase1-50-120%ememy-run1",
                    r"dca-phase1-50-130%ememy-run1",
                    r"dca-phase1-50-140%ememy-run1",
                    r"dca-phase1-50-150%ememy-run1",
                    r"dca-phase1-50-160%ememy-run1",
                ],
    ...
    "MISSIONS.collective_assult_debug.collective_assult_parallel_run.py->ScenarioConfig-->num_attackers":
                [
                    55,
                    55,
                    55,
...
base_conf = {
    "config.py->GlobalConfig": { 
        "note": "50RL-55opp-conc4histPr",   #  实验存储路径
        "env_name": "collective_assult_debug",  #  环境（任务名称）
        "env_path": "MISSIONS.collective_assult_debug", 
        "draw_mode": "Img",
    ...
    "ALGORITHM.conc_4hist_pr.foundation.py->AlgorithmConfig": {
        ...
        "_div_tree_level_inc_per_update": 0,
